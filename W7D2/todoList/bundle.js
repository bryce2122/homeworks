...
window.selector = _selectors2.default;
...
var _todos_reducers = __webpack_require__(51);

var _todos_reducers2 = _interopRequireDefault(_todos_reducers);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({ todos: _todos_reducers2.default });
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODOS:
      var newState = {};
      action.todos.forEach(function (obj, idx) {
        newState[idx + 1] = obj;
      });
...
var allTodos = function allTodos(state) {
    ...
    return keys.map(function (objId) {
        return state.todos[objId];
    });
};
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.props.todos.map(function (obj, idx) {
            return _react2.default.createElement(_todo_list_item2.default, { key: idx, title: obj.title });
          })
        ),
...
var _unique_id = __webpack_require__(80);
...
var todoForm = function (_React$Component) {
  ...
  function todoForm(props) {
    ...
    _this.state = { title: "", body: "", done: false, id: (0, _unique_id2.default)() };
    return _this;
  }
